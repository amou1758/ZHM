"""
Django settings for ZHM project.
...
SECRET_KEY = '()(dlz*u-cf9e!=lo*dlp&0xh&9+@ed3w4f)a266=v=0q=idwl'
...
WSGI_APPLICATION = 'ZHM.wsgi.application'
...
HAYSTACK_SIGNAL_PROCESSOR 指定什么时候更新索引，这里我们使用 haystack.signals.RealtimeSignalProcessor，作用是每当有文章更新时就更新索引。
"""